# illuminabarcodeparser only works on barcodes at the R1 end, or R1 and R2 together.
# But our barcodes are at the R2 end.
# We therefore need to convert R2 sequences to R1 by taking the reverse complement.
